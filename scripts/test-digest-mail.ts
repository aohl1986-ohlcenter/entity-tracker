  ...
  const mock: GenericAlert[] = [
    {
      ...
      subject: 'Rank-Drop: pwc.de #2 → out für "Dana Beispiel Lieferdienste"',
      payload: {
        keyword: "Dana Beispiel Lieferdienste",
        domain: "pwc.de",
        prevPosition: 2,
        newPosition: null,
        droppedOut: true,
    ...
    },
    {
      ...
      subject: 'Rank-Gain: linkedin.com #7 → #2 für "Dana Beispiel e-Grocery"',
      payload: {
        keyword: "Dana Beispiel e-Grocery",
        domain: "linkedin.com",
        prevPosition: 7,
        newPosition: 2,
    ...
    },
    {
      ...
      subject: 'Displacement Top 3: personenverzeichnis-beispiel.example @ #2 für "Dana Beispiel"',
      payload: {
        keyword: "Dana Beispiel",
        domain: "personenverzeichnis-beispiel.example",
        position: 2,
        url: "https://personenverzeichnis-beispiel.example/dana-beispiel",
        matchedLabel: "Personenverzeichnis",
      },
    },
    {
      type: "score_drop",
      ...
      subject: 'Score-Drop 72 → 54 (-18) für "Dana Beispiel Kreislaufwirtschaft"',
      payload: {
        keyword: "Dana Beispiel Kreislaufwirtschaft",
        currentScore: 54,
        avgPrev: 72,
        drop: 18,
        lookbackDays: 7,
