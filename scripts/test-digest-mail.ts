...
async function main() {
  ...
  const mock: GenericAlert[] = [
    ...
    },
    {
      ...
      subject: 'Displacement Top 3: yasni.de @ #2 für "Dana Beispiel"',
      payload: {
        keyword: "Dana Beispiel",
        domain: "yasni.de",
        position: 2,
        url: "https://yasni.de/dana+beispiel/check+person",
        matchedLabel: "Yasni",
      },
    },
    {
      ...
      subject: 'Score-Drop 72 → 54 (-18) für "Dana Beispiel PwC"',
      payload: {
        keyword: "Dana Beispiel PwC",
        currentScore: 54,
        avgPrev: 72,
        drop: 18,
        lookbackDays: 7,
